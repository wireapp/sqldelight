...
abstract class SqlDelightProjectTestCase : LightJavaCodeInsightFixtureTestCase() {
  ...
  private data class SqlDelightDatabasePropertiesImpl(
    ...
    override val enableCustomQueryKeys: Boolean,
